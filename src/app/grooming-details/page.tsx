  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 overflow-x-hidden">
      ...
      <div className="pt-16 relative z-10">
        <BannerSlider slides={bannerSlides} theme="indigo" />
      </div>
      ...
      >
        ...
        <motion.div className="text-center mb-12" variants={itemVariants}>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Our Grooming Services</h1>
            ...
            <button
              ...
              className={`flex items-center px-6 py-3 rounded-full transition-all duration-300 ${
                activeTab === key 
                  ...
                  : 'bg-white/80 text-indigo-700 border border-indigo-200/50 hover:bg-indigo-50/50 hover:border-indigo-300'
              }`}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-indigo-200/50">
              <div className="md:flex">
                <div className="md:w-1/2 p-8 md:p-12 bg-gradient-to-br from-indigo-50/70 to-indigo-100/50">
                ...
                <div className="md:w-1/2">
                  <div className="h-full w-full relative aspect-square">
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-50/70 to-indigo-100/50 z-10"></div>
                    <Image 
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">More From This Service</h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {activeService.images.slice(1).map((image, index) => (
              <motion.div
                key={index}
                className="relative rounded-xl overflow-hidden shadow-lg border border-indigo-200/50"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-indigo-900/40 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <div className="bg-gradient-to-r from-indigo-100/50 to-indigo-200/30 p-8 md:p-12 rounded-2xl shadow-xl relative overflow-hidden border border-indigo-200/50 backdrop-blur-sm">
            <div className="absolute -right-20 -top-20 w-64 h-64 rounded-full bg-indigo-200/30"></div>
            <div className="absolute -left-20 -bottom-20 w-64 h-64 rounded-full bg-indigo-100/30"></div>
            
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Ready to Elevate Your Look?</h2>
